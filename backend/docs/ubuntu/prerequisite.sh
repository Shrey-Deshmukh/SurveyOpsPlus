#!/bin/bash
set -euo pipefail
# prerequisite.sh — Checks Ubuntu system for SurveyOpsPlus backend requirements
...
if command -v docker &>/dev/null; then
    ...
    echo "[MISSING] Docker not found. See: https://docs.docker.com/engine/install/ubuntu/"
    missing+=("docker")
fi
...
if docker compose version &>/dev/null; then
    ...
    echo "[MISSING] Docker Compose not found. See: https://docs.docker.com/compose/install/"
